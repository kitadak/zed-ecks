...
begin:
	...
	ld	hl,attr_top		; load top third title attr
	ld	de,22528		; MAGIC
	ld	bc,256			; copy 256 bytes of attr only
	ldir

	ld	hl,attr_bottom		; load bottom two third title attr
	;ld	de,22528		; DE already is decremented by ldir
